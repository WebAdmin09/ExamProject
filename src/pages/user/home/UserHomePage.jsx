        ...
        <div className='container'>
          <div className='wrapper__home'>
            <div className='home__logo'>
              <a className='heading__home' href="#"><h1 className='heading__home'><i>ABOUT ME</i></h1></a>
            </div>
            <div className='homenav__ul-item'>
          <ul className='homenav__ul'>
           <a className='home__ul-li' href="#"><li className='home__ul-li'>Home</li></a> 
           <a className='home__ul-li' href="#about"><li className='home__ul-li'>About</li></a> 
           <a className='home__ul-li' href="#contact"><li className='home__ul-li'>Contact</li></a> 
           <a className='home__ul-li' href="#skills"><li className='home__ul-li'>Skills</li></a> 
           <a className='home__ul-li' href="#portfolios"><li className='home__ul-li'>Portfolios</li></a> 
          </ul>
            </div>
            <Link to='/login'>
          ...
          <div className='homehead'>
            ...
            <h2 className='homehead__h2'>I am {users?.[0]?.firstName} {users?.[5]?.lastName}</h2>
            <p className='homehead__title'>My username is {users?.[0]?.username}</p>
            <h6 className='homehead__h6'>A small river named 
            Duden flows by their place and supplies it with the
             necessary regelialia</h6>
            </div>
        ...
        <section className='about__section' id='about'>
          ...
          <div className='about__text'>
            ...
            <ul className='about__ul'>
              <li className='about__li'>FullName: {users?.[0]?.firstName}  {users?.[5]?.lastName}</li>
              <li className='about__li'>Birthday: {users?.[0]?.createdAt?.split('T')[0]}</li>
              <li className='about__li'>Age: 21</li>
              <li className='about__li'>Role: {users?.[0]?.role}</li>
            </ul>
          </div>
        </section>
        ...
        <section className='portfolios__section' id='portfolios'>
          <div className='portfolios__text'>
            ...
            <div className='portfolios-card'>
              ...
              <img className='portfolioimg' src={`${ENDPOINT}upload/${el?.photo?._id}.${
